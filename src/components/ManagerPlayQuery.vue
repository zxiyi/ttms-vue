            ...
            <el-table :data="tableData.filter(data => !search || data.name.toLowerCase().includes(search.toLowerCase()))"
                ...
                <el-table-column align="right" style="padding: 0;" width="160px">
                    ...
                    <div slot-scope="scope" style="display: flex;align-items:center;justify-content:space-around">
                        <el-button size="small" type="primary" icon="el-icon-edit" circle onclick="handleEdit(scope.$index, scope.row)"></el-button>
                        <el-button size="small" type="danger" icon="el-icon-delete" circle onclick="handleDelete(scope)"></el-button>
                    </div>
                </el-table-column>
            </el-table>
        </el-main>
